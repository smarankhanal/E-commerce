...
export default function CartSummary() {
  return (
    <div className="w-80 rounded-xl border border-gray-200 bg-white p-6 shadow-sm mb-10">
      ...
      <button className="mt-6 w-full rounded-lg border-2 border-blue-800 bg-blue-800 py-2.5 font-medium text-white transition-all duration-300 hover:bg-white hover:text-blue-800 hover:shadow-lg cursor-pointer">
        Checkout
      </button>
    </div>
  );
